...
if (currentChunkStart.after(globalEnd)) {
    // force 0 loop
    globalMap.put("api_startTime", TalendDate.formatDate(format, globalEnd));
    globalMap.put("api_endTime", TalendDate.formatDate(format, globalEnd));
} else {
    ...
    globalMap.put("api_startTime", TalendDate.formatDate(format, currentChunkStart));
